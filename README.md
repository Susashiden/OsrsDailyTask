...
## Disclaimer
This OSRS Plugin is created by utilizing AI in helping shape my idea for a plugin that I would like to have and sharing it with others that might find it useful or a fun addition to their OSRS journey. This is a passion project.

## Objective

OSRS Daily Tasks is a RuneLite plugin designed to give players a varied, account-specific goal each day. Its objective is to encourage players to engage with different parts of Old School RuneScape through configurable tasks while automatically tracking progress from RuneLite events.
